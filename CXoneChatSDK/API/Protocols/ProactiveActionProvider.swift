...
public protocol ProactiveActionProvider {
    
    /// Triggers a proactive action with the specified action type and associated data.
    ///
    /// This method allows you to trigger a proactive action, for example refresh session when an inactivity popup appears,
    /// by providing the action type and its associated data.
    ///
    /// - Parameter action: The proactive action to trigger with its associated data
    ///
